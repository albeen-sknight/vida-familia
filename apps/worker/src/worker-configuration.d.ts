/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: f61cc3f37d12b2577909537d73e24733)
// Runtime types generated with workerd@1.20260623.1 2026-06-24 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PUBLIC_SITE_URL: "https://vidafamilia.es";
	ALLOWED_ORIGINS: "http://localhost:5173,https://vidafamilia.es,https://www.vidafamilia.es";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SITE_URL" | "ALLOWED_ORIGINS">> {}
}

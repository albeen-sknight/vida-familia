  ...
  return (
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <div className="footer-cta"><p className="eyebrow">START HERE</p><h3>{c.qualificationTitle}</h3><Link to={routeFor(locale, "/apply")}>{c.applyCta}<ArrowUpLeft size={18} /></Link><NewsletterForm locale={locale} compact /><div className="social-links" aria-label="Social media placeholders"><span aria-label="Instagram"><Instagram size={18} /></span><span aria-label="YouTube"><Youtube size={18} /></span></div></div>
      </div>
